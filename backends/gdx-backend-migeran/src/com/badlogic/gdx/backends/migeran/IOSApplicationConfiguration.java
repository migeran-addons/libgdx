...
public class IOSApplicationConfiguration {
	...
	public int depthFormat = GLKViewDrawableDepthFormat._16;
	
	/** the stencil buffer format, None is default **/
	public int stencilFormat = GLKViewDrawableStencilFormat.None;
	
	/** the multisample format, None is default **/
	public int multisample = GLKViewDrawableMultisample.None;
